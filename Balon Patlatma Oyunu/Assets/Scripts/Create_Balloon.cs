...
public class Create_Balloon : MonoBehaviour
{
    ...
    float time1 = 1.2f, counter1 = 1.2f;//Süre-sayaç deðiþkenleri
    float time2 = 4.3f, counter2 = 4.3f;
    float time3 = 7.9f, counter3 = 7.9f;
    float time4 = 10.1f, counter4 = 10.1f;
    ...
    void Update()
    {
        ...
        {
            GameObject go1 = Instantiate(balloon1, new Vector3(Random.Range(1.2f, 5.25f), -0.6f, 0), Quaternion.Euler(0, 0, 0));//Balon üret
        ...
        {
            GameObject go2 = Instantiate(balloon2, new Vector3(Random.Range(1.2f, 5.25f), -0.6f, 0), Quaternion.Euler(0, 0, 0));//Balon üret
        ...
        {            
            GameObject go3 = Instantiate(balloon3, new Vector3(Random.Range(1.2f, 5.25f), -0.6f, 0), Quaternion.Euler(0, 0, 0));//Balon üret
        ...
        {
            GameObject go4 = Instantiate(balloon4, new Vector3(Random.Range(1.2f, 5.25f), -0.6f, 0), Quaternion.Euler(0, 0, 0));//Balon üret
